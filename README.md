...
💬Answer: Based on the confusion matrix, the weakest performing classes are the ones with fewer correct predictions. Vanda Baby Angel has only 274 correct which results it to become the lowest value and shows heavy confusion with vanda classes.<br> <br>
